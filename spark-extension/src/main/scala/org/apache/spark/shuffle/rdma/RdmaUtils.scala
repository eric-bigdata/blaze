...
import org.apache.spark.shuffle.sort.{BypassMergeSortShuffleHandle, SerializedShuffleHandle}
...
class RdmaBaseShuffleHandle[K, V, C](
    val driverTableAddress: Long,
...
class RdmaSerializedShuffleHandle[K, V](
    val driverTableAddress: Long,
    val driverTableLength: Int,
    val driverTableRKey: Int,
    shuffleId: Int,
    dependency: ShuffleDependency[K, V, V])
    extends SerializedShuffleHandle[K, V](shuffleId, dependency)

class RdmaBypassShuffleHandle[K, V](
    val driverTableAddress: Long,
    val driverTableLength: Int,
    val driverTableRKey: Int,
    shuffleId: Int,
    dependency: ShuffleDependency[K, V, V])
  extends BypassMergeSortShuffleHandle[K, V](shuffleId, dependency)